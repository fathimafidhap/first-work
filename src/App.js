...
function App() {
        ...
        <Card style={{ width: '22rem', marginLeft: '70%', height: '39rem' }}>
              ...
              <div className="row">
                ...
                <div className="col-6">
                  ...
                  <div className="form-group">
                    <button className="btn">In Stock (25)</button>
          ...
          <Card.Body style={{ marginTop: "-4%" }}>
            <form action="/action_page.php">
              ...
              <input type="number" style={{ width: "24%", marginTop: "5px" }} id="points" name="points" step="1" />
      ...
      <div className="container">
        ...
        <Card style={{ width: '22rem', marginLeft: "70%", marginTop: "-29%" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
            <svg style={{color:"purple"}}xmlns="http://www.w3.org/2000/svg" width="40" height="30" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
  <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
    ...
    <div  style={{marginLeft:"30%",marginTop:"-19%"}}>
     ...
     <svg style={{color:"purple",marginTop:"1%"}} xmlns="http://www.w3.org/2000/svg" width="40" height="30" fill="currentColor" class="bi bi-telephone-inbound" viewBox="0 0 16 16">
...
<div  style={{marginLeft:"30%",marginTop:"-14%"}}>
     ...
     <svg  style={{color:"purple",marginTop:"2%"}}xmlns="http://www.w3.org/2000/svg" width="40" height="30" fill="currentColor" class="bi bi-file-lock" viewBox="0 0 16 16">
...
<div style={{marginLeft:"30%",marginTop:"-14%"}}>
     ...
     <svg style={{color:"purple",marginTop:"2%"}}xmlns="http://www.w3.org/2000/svg" width="40" height="30" fill="currentColor" class="bi bi-tags-fill" viewBox="0 0 16 16">
